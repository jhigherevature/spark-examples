...
public class Room extends Fixture {
	 ...
	 * 
	 * for example: a switch statement or if/else statement
	 * can arbitrarily determine that "north" is associated with
	 * index 0, "west is associated with index 1, and so on...
	 */
